...
export const siteThemes: Record<string, SiteTheme> = {
  ...
  'github-light': {
    ...
    '--glow-green': '0 0 8px rgba(26, 127, 55, 0.25)',
    '--glow-blue': '0 0 8px rgba(9, 105, 218, 0.25)',
    '--glow-orange': '0 0 8px rgba(154, 103, 0, 0.25)',
    '--glow-red': '0 0 8px rgba(207, 34, 46, 0.25)',
    '--glow-purple': '0 0 8px rgba(130, 80, 223, 0.25)',
  },
}
